...
| Strict content/detail page quality / social preview / sharing | `registry/content-page-quality-contract.json`, `docs/CONTENT-PAGE-QUALITY-CONTRACT.md`, `skills/arwp-content-page-quality/SKILL.md`, `registry/comprehensive-site-audit.json` | final generated content/detail HTML; page/layout metadata source; representative share images; end-of-content Share/Copy/direct-provider footer; optional real feedback sink; content-family CI evidence | `node scripts/content-page-quality-test.mjs`; `node bin/arwp-content-page-quality.mjs <html-or-build-root> --base-url=<canonical-root> --strict`; enumerate every applicable content/detail page for deterministic checks and runtime-test each distinct distribution implementation; do not treat share controls as ranking or confirmed social-share outcome evidence |
