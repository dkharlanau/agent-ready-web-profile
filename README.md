...
Start with the [pattern library](https://dkharlanau.github.io/agent-ready-web-profile/discoverability.html): **209 patterns, 114 sources and 16 categories** for useful editorial work, honest comparisons, structured data and usable interfaces. Every pattern carries a version and review status; 93 have an individual source-support review. Select a few, export a version-pinned plan, then use the Growth Loop to verify and measure the change. [Version contract](docs/DISCOVERABILITY-VERSIONING.md).
