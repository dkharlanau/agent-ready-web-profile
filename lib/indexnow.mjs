...
export function normalizeIndexNowUrls(site, urls) {
  ...
  if (!list.length) throw new Error('At least one changed URL is required.');
  if (list.length > INDEXNOW_MAX_URLS) throw new Error(`IndexNow supports at most ${INDEXNOW_MAX_URLS} URLs per POST.`);
