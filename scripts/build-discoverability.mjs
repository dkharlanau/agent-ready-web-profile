...
<header class="goose-header"><a class="goose-brand" href="./"><strong>Goose</strong><span>ARWP<br>GET FOUND.</span></a><nav aria-label="Primary"><a href="#library">Patterns</a><a href="#evidence-guide">Evidence</a><a href="./EDITORIAL-SEARCH-LAB.html">Writing lab</a><a href="https://github.com/dkharlanau/agent-ready-web-profile">GitHub</a></nav></header>
<main><section class="goose-hero goose-shell"><div class="goose-hero-copy"><p class="eyebrow">THE DISCOVERABILITY LIBRARY / V${esc(corpus.version)}</p><h1>Get<br>Found.</h1><p class="goose-lead">Practical patterns. Traceable sources.<br class="desktop-break"> Changes you can measure.</p><div class="goose-actions"><a class="goose-button" href="#library">Find a pattern</a><a class="goose-text-link" href="#evidence-guide">How evidence works</a></div><dl class="goose-edition"><div><dt>Patterns</dt><dd>${corpus.tactics.length}</dd></div><div><dt>Categories</dt><dd>${corpus.categories.length}</dd></div><div><dt>Sources</dt><dd>${corpus.sources.length}</dd></div><div><dt>Corpus release</dt><dd>${esc(corpus.version)}</dd></div></dl></div><img class="goose-hero-art" src="./media/cite-goose/hero.webp" alt="An illustrated goose carrying a note: Show your sources." width="1024" height="1024" fetchpriority="high"></section>
...
console.log(`Built Goose library: ${corpus.tactics.length} patterns and ${corpus.sources.length} sources; sitemap is managed separately.`);
