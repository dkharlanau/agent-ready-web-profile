...
<meta name="theme-color" content="#eff600"><meta property="og:title" content="Goose — Make your site worth citing."><meta property="og:description" content="Practical patterns. Traceable sources. Changes you can measure."><meta property="og:type" content="website"><meta property="og:url" content="https://dkharlanau.github.io/agent-ready-web-profile/discoverability.html">
...
<header class="goose-header"><a class="goose-brand" href="./"><strong>Goose</strong><span>AGENT-READY<br>WEB PROFILE</span></a><nav aria-label="Primary"><a href="#library">Patterns</a><a href="#evidence-guide">Evidence</a><a href="./EDITORIAL-SEARCH-LAB.html">Writing lab</a><a href="https://github.com/dkharlanau/agent-ready-web-profile">GitHub</a></nav></header>
...
<footer class="goose-footer goose-shell"><a class="goose-brand" href="./"><strong>Goose</strong></a><p>Better questions. Useful pages. Traceable changes.</p><a href="./EDITORIAL-RECEIPTS.md">Editorial receipt contract</a></footer></main></body></html>\n`;
