...
const banner = `<div id="portfolio-analytics-consent" role="dialog" aria-label="Measurement preference" style="position:fixed;z-index:2147483647;right:16px;bottom:16px;max-width:390px;padding:16px;border:1px solid #d0d7de;border-radius:12px;background:#fff;color:#1f2328;font:14px/1.45 system-ui,sans-serif;box-shadow:0 8px 30px rgba(0,0,0,.18)">
  <strong style="display:block;margin-bottom:6px">Help us improve</strong>
  <span>Help us understand which pages are useful? This optional, anonymous measurement starts only if you choose “Allow.”</span>
