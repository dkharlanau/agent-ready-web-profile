...
assert.ok(graph['@graph'].length >= 13);
...
for (const dataset of [observatory, crawlerMatrix]) {
...
for (const suffix of ['term-agentic-web-resolver', 'term-resolver-regret', 'term-discovery-conflict']) {
...
console.log('PASS ARWP knowledge graph keeps maintainer, software, site, trust, datasets, claims and project vocabulary linked through stable canonical entities');
