# Cite Goose visual identity

Identity revision 1.1 — 2026-09-08.

**Cite Goose** is the product-facing name. **Agent-Ready Web Profile** and **ARWP** remain technical aliases; package names, CLI commands, canonical URLs and entity IDs retain their existing identity. No registered or cleared trademark status is asserted.
...
Cite Goose should model the same discipline it recommends to other sites: **own a problem, not a pile of adjacent topics**.
